var MVVM = {
    ...
    init: function () {
        ...
        var viewModel = function () {
            ...
            this.declineDocument = function (document) {
                // Perform the decline logic here
                // Similar to approveDocument, you might update a status property
                // or send a request to update the backend

                // For demonstration purposes, let's update a property called "approved"
        ...
        if (dt_basic_table.length) {
            var dt_basic = dt_basic_table.DataTable({
                ...
                ajax: function (data, callback, settings) {
                    ...
                    jqueryAjaxGenerics.createJSONAjaxNonGETRequest("POST", "/Accounts/SelectAgent/GetAgents", modelToSend,
                        functionDone, functionFailed);
...

                    {
                        ...
                        render: function (data, type, full, meta) {
                            return (
                                ...
                                //'<a href="javascript:;" class="dropdown-item make-payments">' +
                                //feather.icons['dollar-sign'].toSvg({ class: 'font-small-4' }) +
                                //' Add Payments details</a>' +
                                '<a href="javascript:;" class="dropdown-item additional-view">' +
            ...
            $('div.head-label').html('<h5>Agents</h5>');
