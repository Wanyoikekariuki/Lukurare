    ...
    init: function () {
        ...
        var viewModel = function () {
            ...
            this.addUser = function () {
                ...
                var data = {
                    Id: self.Id(),
                    Username: self.EntityUserName(),
                    PhoneNumber: self.Phone1(),
                    EmailAddress: self.Email(),
                    IsActive: self.selectedOption()
                };
                debugger;
                jqueryAjaxGenerics.createJSONAjaxNonGETRequest("POST", "/Accounts/Users/Add", data,
                    functionDone, functionFailed);
            ...
            this.editUser = function () {
                ...
                var data = {
                    Id: self.Id(),
                    Username: self.EntityUserName2(),
                    PhoneNumber: self.Phone12(),
        ...
        //                    header: function (row) {
        //                        var data = row.data();
        //                        return 'Details of ' + data['EntityUserName'];
        //                    }
        //                }),
        //                type: 'column',
      ...
      $('.datatables-basic tbody').on('click', '.item-edit', function () {
            ...
            debugger;
            var data = dt_basic.row($(this).parents('tr')).data();
            myModel.EntityUserName2(data.Username);
            myModel.Email2(data.EmailAddress);
            myModel.Phone12(data.PhoneNumber);
            myModel.Id(data.Id);
            myModel.selectedOption(data.IsActive);
