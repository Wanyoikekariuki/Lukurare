var MVVM = {
    ...
    init: function () {
        ...
        var viewModel = function () {
            ...
            this.loggedInEntity = ko.observable("")
            ...
            this.Path = ko.observable(); // Adjust the path accordingly
            ...
            // Sample function to decline a document
            ...
            var dt_basic = dt_basic_table.DataTable({
                ...
                ajax: function (data, callback, settings) {
                    ...
                    var functionDone = function (hasError, message, data) {
                        ...
                        //    data[i].Balance = data[i].Retainer;
                    ...
                    jqueryAjaxGenerics.createJSONAjaxNonGETRequest("POST", "/Accounts/SelectAgent/GetAllCustomers", modelToSend,
                        functionDone, functionFailed);
                ...
                columnDefs: [
                    ...
                    {
                        // Actions
                        targets: 6,//fifth place from the data table
                        visible: true
                    },
                   
                    {
                        // Actions
                        targets: 7,//fifth place from the data table
                        visible: false,
                        responsive: true,
                        title: 'Status',
                        orderable: false,
                    ...
                    {
                        targets: 8,//sixth place from the data table
                        responsive: true,
                        title: 'Fee Paid',
                        orderable: false,
                        render: function (data, type, full, meta) {
