        ...
        if (dtInvoiceTable.length) {
            var dtInvoice = dtInvoiceTable.DataTable({
                ajax: function (data, callback, settings) {
                    ...
                    debugger;
                    var modelToSend = {
                        AccountNameAlias: "smart water meter",
                        AccountTypeName: "Water Meter"
                    };
                ...
                initComplete: function () {
                    ...
                    this.api()
                        ...
                        .every(function () {
                                ...
                                .on('change', function () {
                                    ...
                                    if (select.val() == "Date") {
                                        ...
                                        $('#sendDateFilter').on('click', function () {
                                            debugger;
                                            //var from = $('#from-date-time').val();
                                            //var to = $('#to-date-time').val();
                            ...
                            /*select.append('<option value="Group" class="text-capitalize">Contact Groups</option>');*/
