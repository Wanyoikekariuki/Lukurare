        ...
        if (dt_basic_table.length) {
            ...
            var dt_basic = dt_basic_table.DataTable({
                ...
                ajax: function (data, callback, settings) {
                    ...
                    var functionDone = function (hasError, message, data) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            data[i].Id = data[i].Id;
                            data[i].EntityName = data[i].EntityName;
                            data[i].EntityUserName = data[i].EntityUserName;
                            data[i].Age = data[i].EntityNo;
                            data[i].IdNo = data[i].Phone2;
                            data[i].Education = data[i].PostalAddress;
                    ...
                    jqueryAjaxGenerics.createJSONAjaxGETRequest("/Reports/CreditAllocationReport/GetReport",
                        functionDone, functionFailed);
                ...
                columns: [
                    ...
                    { data: 'IdNo' },
                    { data: 'Age' },
                    { data: 'Education' }//AccountEntityContact.BillReferenceServiceType.ServiceName
