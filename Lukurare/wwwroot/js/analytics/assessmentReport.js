var initializeMessageOutbox = {
    ...
    LoadGrid: function () {
        ...
        var currentGridName = "AssessmentReport";
        ...
        var dataSource = kendoGridCRUDHelper
            .createStandardDataSource($("#smsInboxSection"), schema, "/SchoolMS/Analytics/AssessmentReport", currentGridName, initializeMessageOutbox);

        //define grid columns
        var fieldColumns = [
            { field: "Entity.EntityName", title: 'Learner Name', width: "15%" },
            { field: "PhoneNumber", title: 'Phone', width: "15%", },
            { field: "Message", title: 'Assessment Question', width: "35%", },
