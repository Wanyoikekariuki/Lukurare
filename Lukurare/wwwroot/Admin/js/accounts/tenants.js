...
var MVVM = {
    init: function () {
        var viewModel = function () {
            ...
            this.AmountTypes = ko.observableArray(["Arrears", "Overpayment"]);
            this.SelectedAmountType = ko.observable();
            this.AmountIn = ko.observable();
            this.AmountOut = ko.observable();
            this.Amount = ko.observable();
            this.Narration = ko.observable();
            ...
            this.addArrears = function () {
                ...
                if (self.SelectedAmountType() == "Arrears") {

                    self.AmountOut(parseFloat(self.Amount()));
                    self.AmountIn(0);
                    self.Narration( "Arrears added from portal");
                }
                else {
                    self.AmountIn(parseFloat(self.Amount()));
                    self.AmountOut(0);
                    self.Narration("Over-Payment added from portal");
                }

                var data = {
                    MfsEntityAccountId: self.EntityId(),
                    AmountInCredit: self.AmountIn(),
                    AmountOutDebit: self.AmountOut(),
                    Narration: self.Narration()
                    
                };
                debugger;
                jqueryAjaxGenerics.createJSONAjaxNonGETRequest("POST", "/Accounts/MeterAccountTransaction/Add", data,
                    functionDone, functionFailed);
   ...
   var dt_basic_table = $('.datatables-basic'),
        ...
        if (dt_basic_table.length) {
                ...
                ajax: function (data, callback, settings) {
                    ...
                    var functionDone = function (hasError, message, data) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            data[i].EntityUserName = data[i].AccountEntity.EntityUserName;
                            data[i].EntityName = data[i].AccountEntity.EntityName;
                            data[i].EntityNo = data[i].AccountEntity.EntityNo;
                            data[i].PhysicalAddress = data[i].AccountEntity.PhysicalAddress;
                    ...
                    jqueryAjaxGenerics.createJSONAjaxGETRequest("/Accounts/MeterAccount/GetTenants",
                        functionDone, functionFailed);
                },
            ...
            $('div.head-label').html('<h5>Tenants</h5>');
        ...
        $('.datatables-basic tbody').on('click', '.add-meter', function () {
            ...
            myModel.EntityName(data.EntityUserName);
