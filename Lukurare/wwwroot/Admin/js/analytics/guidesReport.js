var initializeMessageOutbox = {
    ...
    LoadGrid: function () {
        ...
        var currentGridName = "GuidesReport";
        ...
        var dataSource = kendoGridCRUDHelper
            .createStandardDataSource($("#smsInboxSection"), schema, "/SchoolMS/Analytics/GuidesReport", currentGridName, initializeMessageOutbox);

        //define grid columns
        var fieldColumns = [
            { field: "Entity.EntityName", title: 'Learner Name', width: "15%" },
            { field: "PhoneNumber", title: 'Phone', width: "15%", },
            { field: "Message", title: 'Guide content', width: "35%", },
