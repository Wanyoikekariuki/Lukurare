                ...
                this.checkEntityTypes = function () {
                    ...
                    var functionDone = function (hasError, message, data) {
                        ...
                        if (hasError) {
                            ...
                            self.selectedEntityType(data.Result[2]);
            ...
            this.validateEmail = function () {
                ...
                this.validate= function () {
                    ...
                    if (!self.Username()) {
                        ...
                        this.showErrorMessage("Validation Failed", "Physical Address can not be empty");
                        return false;
                    }
                    else if (!self.PostalAddress()) {
                        this.showErrorMessage("Validation Failed", "Industry Sector can not be empty");
                        return false;
                    }
                ...
                this.registerReseller = function () {
                    ...
                    $.ajax({
                        ...
                        try {
                            ...
                            // Call the success function after a delay
                            setTimeout(succesFunction, 2000);  // 2000 milliseconds = 2 seconds
