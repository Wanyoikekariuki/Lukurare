...
//{
//    public class LessonGuidesRepository : EFDatabaseModelBaseRepository<SchoolMsLessonGuide>
//    {
//        public LessonGuidesRepository(string currentModule)
//            : base(currentModule) { }
